package io.github.dudupuci.appdespesas.infrastructure.config.persistence;
...
public class TransacionalInterceptor {
    ...
    @Around("@annotation(io.github.dudupuci.appdespesas.infrastructure.config.persistence.Transacional) || @within(io.github.dudupuci.appdespesas.infrastructure.config.persistence.Transacional)")
