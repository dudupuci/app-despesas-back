...
@Getter
@Setter
public class JpaCategoria extends JpaEntidadeUuid {
    ...
    private Set<JpaMovimentacao> movimentacoes = new HashSet<>();
     ...
     */
    public static JpaCategoria fromEntity(Categoria categoria) {
        if (categoria == null) return null;

        JpaCategoria jpaCategoria = new JpaCategoria();
        jpaCategoria.fromDomain(categoria);
        jpaCategoria.setNome(categoria.getNome());
        jpaCategoria.setDescricao(categoria.getDescricao());
        jpaCategoria.setStatus(categoria.getStatus());
        jpaCategoria.setTipoMovimentacao(categoria.getTipoMovimentacao());
        return jpaCategoria;
    }
