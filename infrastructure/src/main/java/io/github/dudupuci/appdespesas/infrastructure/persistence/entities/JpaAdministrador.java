...
@Getter
@Setter
public class JpaAdministrador extends JpaEntidadeUuidManual {
     ...
     */
    public static JpaAdministrador fromEntity(Administrador admin) {
        if (admin == null) return null;

        JpaAdministrador jpaAdmin = new JpaAdministrador();
     ...
     */
    public static JpaAdministrador criarSuperAdmin(JpaRole adminRole) {
        JpaAdministrador admin = new JpaAdministrador();
