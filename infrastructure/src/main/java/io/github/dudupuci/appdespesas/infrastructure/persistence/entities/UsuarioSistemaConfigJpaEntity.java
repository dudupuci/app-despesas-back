...
@Getter
@Setter
public class UsuarioSistemaConfigJpaEntity extends JpaEntidadeUuid {
    ...
    public UsuarioSistemaConfigJpaEntity() {
        super();
    }
     ...
     */
    public static UsuarioSistemaConfigJpaEntity fromEntity(UsuarioSistemaConfig config) {
        if (config == null) return null;

        UsuarioSistemaConfigJpaEntity jpaConfig = new UsuarioSistemaConfigJpaEntity();
