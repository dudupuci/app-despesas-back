...
@Getter
@Setter
public abstract class JpaEntidadeUuid extends EntidadeUuid {
     ...
     */
    protected void fromDomain(EntidadeUuid domain) {
     ...
     */
    protected void toDomain(EntidadeUuid domain) {
