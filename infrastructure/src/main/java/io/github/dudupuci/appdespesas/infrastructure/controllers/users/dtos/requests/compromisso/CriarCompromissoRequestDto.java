...
import io.github.dudupuci.appdespesas.application.usecases.compromisso.CompromissoCommand;
...
public record CriarCompromissoRequestDto(
    ...
    public CompromissoCommand toCommand(UUID usuarioId, UUID compromissoId) {
        return new CompromissoCommand(usuarioId, compromissoId, titulo, descricao, dataInicio, dataFim, diaInteiro, prioridade, localizacao, cor, observacoes);
    }
