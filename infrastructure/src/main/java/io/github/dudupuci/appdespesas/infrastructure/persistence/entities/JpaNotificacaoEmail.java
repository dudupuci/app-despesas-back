...
@Getter
@Setter
public class JpaNotificacaoEmail extends JpaEntidadeImutavelUuid {
    ...
    public JpaNotificacaoEmail() {
        super();
    }

    public JpaNotificacaoEmail(String titulo, String mensagem, UUID usuarioId, TipoNotificacao tipoNotificacao, CanalNotificacao canalNotificacao) {
        super();
        this.titulo = titulo;
     ...
     */
    public static JpaNotificacaoEmail fromEntity(NotificacaoEmail notificacao) {
        if (notificacao == null) return null;

        JpaNotificacaoEmail jpaNotificacao = new JpaNotificacaoEmail();
